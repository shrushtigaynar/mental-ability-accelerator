...
import { getMemoryQuestions, submitTestResults, TRAINING_TOPICS } from "../api/practice.js";
...
export default function MemoryTraining() {
  ...
  const topics = TRAINING_TOPICS['deep-thinking'];
...
const getOptionStyle = (idx) => {
  ...
  const loadQuestions = async () => {
    ...
    try {
      const data = await getMemoryQuestions(token, selectedTopic?.name, selectedDifficulty);
            ...
            {topics.map((topic) => (
              ...
              >
                ...
                <button
                  ...
                  className="mt-4 w-full rounded-full bg-gradient-to-r from-sky-500 to-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-blue-500/30 transition hover:from-sky-400 hover:to-blue-500"
                >
                  Start Practice →
                </button>
              </div>
            ...
            {loading ? (
              ...
              <div className="mt-10 space-y-4">
                ...
                <div className="mt-4 flex gap-3">
                  <button
                    type="button"
                    className="flex-1 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-sky-500 to-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/30 transition hover:from-sky-400 hover:to-blue-500"
                    onClick={() => navigate("/dashboard")}
                  >
                    Back to Dashboard
                  </button>
              ...
              <div className="flex gap-6 mt-8">
                  ...
                  <div className="flex items-center gap-3">
                    <div className={`flex h-9 w-14 items-center justify-center rounded-full border text-sm font-semibold transition ${
                      timeLeft <= 10 
                        ...
                        : 'border-sky-500/60 bg-slate-900/80 text-sky-200'
                    }`}>
                      {timeLeft}s
                    </div>
                  </div>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {currentOptions.map((option, idx) => {
                    ...
                    const selectedStyle = isSelected ? " border-blue-400/80 bg-blue-600 text-white" : " hover:border-sky-400/80 hover:text-sky-200";
